...
class Token():
    ...
    initial_amount = 20000000 * 100000000  # 20m to owners * 10^8
    ...
    # maximum amount you can mint in the limited round ( 5 neo/person * 160 Tokens/NEO * 10^8 )
    max_exchange_limited_round = 5 * 160 * 100000000
